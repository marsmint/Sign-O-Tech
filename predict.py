...
model = keras.models.load_model(r"C:\Users\kit\PycharmProjects\pythonProject\second_model.h5")
...
while True:
    ...
    if num_frames < 100:
        ...
        cv2.putText(frame_copy, "Adjust your Hand in the blue rectangle", (200, 400), cv2.FONT_HERSHEY_SIMPLEX, 1,
                    (0, 0, 255), 2)
